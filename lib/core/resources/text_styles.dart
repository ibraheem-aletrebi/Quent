...
import 'package:quent/core/resources/app_size_helper.dart';
...
class TextStyles {
  ...
  static final TextStyle bold20 = _buildTextStyle(
    fontSize: AppSizeHelper.s20,
    fontWeight: FontWeightHelper.bold,
  );


    static final TextStyle bold32 = _buildTextStyle(
    fontSize: AppSizeHelper.s32,
    fontWeight: FontWeightHelper.bold,
  );
}
