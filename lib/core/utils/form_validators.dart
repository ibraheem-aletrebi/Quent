...
class FormValidators {  
  ...
  static String? email(String? value, String emptyMessage, String invalidMessage) {
  ...
  static String? confirmPassword(
      String? password, String? confirmPassword, String message) {
  ...
  static String? phone(String? value, String emptyMessage, String invalidMessage) {
    if (value == null || value.isEmpty) return emptyMessage;
  ...
  static String? nationalId(String? value, String emptyMessage, String invalidMessage) {
    if (value == null || value.isEmpty) return emptyMessage;
